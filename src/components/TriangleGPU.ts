...
import fragmentShader from '@/shaders/triangleGPU/frag.glsl';
import vertexShader from '@/shaders/triangleGPU/vert.glsl';

export default class TriangleGPU extends Object3D {
    ...
    createLine() {
        ...
        const otherPoints = [];
        otherPoints.push(this.p1.x, this.p1.z, this.p2.x, this.p2.z);
        otherPoints.push(this.p2.x, this.p2.z, this.p0.x, this.p0.z);
        otherPoints.push(this.p0.x, this.p0.z, this.p1.x, this.p1.z);
        geometry.setAttribute('otherPoints', new Float32BufferAttribute(otherPoints, 4));
